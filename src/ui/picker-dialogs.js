...
export function colorPickerDialog(id = 'cpd', selected = '#B0B0B0', onSelect = '') {
  ...
  return `<div id="${id}-dialog" class="dialog-overlay" style="display:none" onclick="if(event.target===this)this.style.display='none'" onkeydown="if(event.key==='Escape')this.style.display='none'" role="dialog" aria-modal="true" aria-labelledby="${id}-dialog-title" aria-hidden="true">
    <div class="dialog-panel" style="max-width:360px">
      <div class="dialog-header"><span class="dialog-title" id="${id}-dialog-title">Choose Color</span><button class="dialog-close" onclick="document.getElementById('${id}-dialog').style.display='none'" aria-label="Close dialog">&times;</button></div>
...
export function dateChoiceDialog(id = 'dcd') {
  ...
  return `<div id="${id}-dialog" class="dialog-overlay" style="display:none" onclick="if(event.target===this)this.style.display='none'" onkeydown="if(event.key==='Escape')this.style.display='none'" role="dialog" aria-modal="true" aria-labelledby="${id}-dialog-title" aria-hidden="true">
    <div class="dialog-panel" style="max-width:380px">
      <div class="dialog-header"><span class="dialog-title" id="${id}-dialog-title">Choose Date</span><button class="dialog-close" onclick="document.getElementById('${id}-dialog').style.display='none'" aria-label="Close dialog">&times;</button></div>
...
export function stageTransitionDialog(stages = null) {
  ...
  return `<div id="stage-trans-dialog" class="dialog-overlay" style="display:none" onclick="if(event.target===this)this.style.display='none'" onkeydown="if(event.key==='Escape')this.style.display='none'" role="dialog" aria-modal="true" aria-labelledby="stage-trans-dialog-title" aria-hidden="true">
    <div class="dialog-panel">
      <div class="dialog-header"><span class="dialog-title" id="stage-trans-dialog-title">Transition Stage</span><button class="dialog-close" onclick="document.getElementById('stage-trans-dialog').style.display='none'" aria-label="Close dialog">&times;</button></div>
      <div class="dialog-body">
...
export function teamAssignmentDialog(id = 'tad') {
  return `<div id="${id}-dialog" class="dialog-overlay" style="display:none" onclick="if(event.target===this)this.style.display='none'" onkeydown="if(event.key==='Escape')this.style.display='none'" role="dialog" aria-modal="true" aria-labelledby="${id}-dialog-title" aria-hidden="true">
    <div class="dialog-panel">
      <div class="dialog-header"><span class="dialog-title" id="${id}-dialog-title">Assign Team Members</span><button class="dialog-close" onclick="document.getElementById('${id}-dialog').style.display='none'" aria-label="Close dialog">&times;</button></div>
      <div class="dialog-body">
