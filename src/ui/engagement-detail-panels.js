...
export function checklistPanel(engId) {
  return `<div id="tab-checklist" class="eng-tab-panel" style="display:none"><div class="card-clean"><div class="card-clean-body">
    <div class="flex justify-between items-center mb-4"><h2 style="font-size:0.875rem;font-weight:600">Checklists</h2><a href="/review?engagement_id=${esc(engId)}" class="btn btn-ghost btn-sm">Manage in Review</a></div>
